...
<head>
    ...
    <title><?php echo $property ? htmlspecialchars($property['title']) : 'Hotel Details'; ?> - Airbnb Clone</title>
    <style>
        body {
...
<body>
    <header>
        <h1><?php echo $property ? htmlspecialchars($property['title']) : 'Hotel Details'; ?></h1>
    </header>
    <div class="details">
        ...
        <?php else: ?>
            <div class="gallery">
                <img class="main-img" src="<?php echo $property['image'] ?? 'https://via.placeholder.com/800x400'; ?>" alt="Hotel">
            </div>
            <div class="info">
                <h2>Details</h2>
